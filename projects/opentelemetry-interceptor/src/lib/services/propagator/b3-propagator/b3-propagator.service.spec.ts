...
import { b3PropagatorSingleConfig, b3PropagatorMultiConfig } from '../../../../../__mocks__/data/config.mock';
...
describe('B3PropagatorService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideB3Propagator(), { provide: OTEL_CONFIG, useValue: b3PropagatorMultiConfig }],
    });
  ...
  it('should return an B3Propagator with single header', () => {
    ...
    TestBed.configureTestingModule({
      providers: [provideB3Propagator(), { provide: OTEL_CONFIG, useValue: b3PropagatorSingleConfig }],
    });
    b3PropagatorService = TestBed.inject(B3PropagatorService);
    expect(b3PropagatorService.getPropagator()).toBeInstanceOf(B3Propagator);
  });
